...
INSERT INTO
  public.products (name, price, description, image_url)
VALUES
  (
    'Swiss Cheese',
    956.97,
    ...
    'https://i.ibb.co/N16wJ48/swiss-cheese.png'
  );
...
VALUES
  (
    ...
    'https://i.ibb.co/4fn5HJv/pear.png'
  );
...
VALUES
  (
    ...
    'https://i.ibb.co/B6pr46Z/muffins.png'
  );
...
VALUES
  (
    ...
    'https://i.ibb.co/TB3vQy2/Wasabi-Paste.jpg'
  );
...
VALUES
  (
    ...
    'https://i.ibb.co/3TVtKHm/triple.jpg'
  );
...
VALUES
  (
    ...
    'https://i.ibb.co/Vp9fw0F/campbell-chicken-soup.jpg'
  );
...
VALUES
  (
    ...
    'https://i.ibb.co/B65SyN5/sage-ground.jpg'
  );
...
VALUES
  (
    ...
    'https://i.ibb.co/Np4L8bs/beef-consomme.jpg'
  );
...
VALUES
  (
    ...
    'https://i.ibb.co/hXsSSCt/Sausage-Chorizo.jpg'
  );
...
VALUES
  (
    ...
    'https://i.ibb.co/4f81wgz/bacardi.png'
  );
...
VALUES
  (
    ...
    'https://i.ibb.co/mCMhF9N/meat-filling.jpg'
  );
...
VALUES
  (
    ...
    'https://i.ibb.co/h9Bm7nP/lamb-shoulder.png'
  );
...
Produced in a peanut and nut-free environment.',
    'https://i.ibb.co/KXqcnsG/icecream.png'
  );
...
VALUES
  (
    ...
    'https://i.ibb.co/1LX9RMw/puree-raspberry.jpg'
  );
...
Sweetened only with vineyard ripened grape and fruit juices, 100 percent from fruit Authentic French Recipe, Gently cooked to preserve the natural flavor of the fruit, Gluten-Free, Only Natural Sugars, Non-Genetically Modified Ingredients, No Cane Sugars, Corn Syrups, Artificial Sweeteners, Colors, Flavors, or Preservatives, All Natural Ingredients',
    'https://i.ibb.co/znrFfPt/jam.jpg'
  );
...
VALUES
  (
    ...
    'https://i.ibb.co/Srv1Hjr/rice.png'
  );
...
VALUES
  (
    ...
    'https://i.ibb.co/ZcPjq1Y/berry.png'
  );
